function [ TargetFunctionValue ] = TargetFunction( rhos,Population1st,length,a,b )
%目标函数
%   此处显示详细说明
...
%     TargetFunctionValue(i)=norm(log2(rhos)-log2(WFEM_forward( lambda(i,1:3),lambda(i,4:5) )));
    TargetFunctionValue(i)=F_target(  rhos,lambda(i,:) );
end
