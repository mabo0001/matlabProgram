function [ TargetFunctionValue ] = TargetFunction( rhos,Population1st,length,a,b,x,y,LayerNumber )
%目标函数
%   此处显示详细说明
...
for i=1:size(Population1st,1)
    TargetFunctionValue(i)=norm(log2(rhos)-log2(WFEM_forward( lambda(i,1:LayerNumber),lambda(i,LayerNumber+1:end),x,y )));
end
