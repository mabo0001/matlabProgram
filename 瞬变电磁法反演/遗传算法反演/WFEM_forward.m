function [ rho_WFEM ] = WFEM_forward( rho_i,h_i,xx,yy )
%广域电磁法一维正演函数
%   此处显示详细说明
global x
global y
...
[rho_WFEM(i),resnorm,residual,exitflag,output]=lsqnonlin(@CSAMT_halfspace,a0,al,au,options,i);   %进行最小二乘法拟合，exitflag：终止计算条件，若是收敛后退出，小于0
end
%%%%%%%%%%%%%%CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC最小二乘拟合

% loglog(f,rho_WFEM,'-r','LineWidth',1.5);
% title('广域电磁法一维正演视电阻率曲线','Fontsize',10,'Fontweight','bold')
% xlabel('Freq/Hz','Fontsize',10,'Fontweight','bold');
